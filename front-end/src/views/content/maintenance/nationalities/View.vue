    ...
    <b-row>
      <b-col>
        <server-side-paginated-table
                ...
                ref="displayTable"
                top_right_btn="Add New Nationality"
        />
      </b-col>
    </b-row>
    <form-modal
...
<script>
    ...
    import ServerSidePaginatedTable from '@/views/content/maintenance/nationalities/NationalitiesTable.vue';
    import FormModal from '@/views/content/maintenance/nationalities/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/nationalities/get_all',
                    delete_url:'maintenance/nationalities/delete',
                    fields:[
        ...
        methods:{
            resetFormData(){
                ...
                this.form_data.nice_name='';
                this.form_data.iso3='';
                this.form_data.num_code='';
                this.form_data.country_code='';
                this.form_data.is_preferred=false;
            }
        }
    }
</script>
