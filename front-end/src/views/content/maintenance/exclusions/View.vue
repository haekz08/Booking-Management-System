    ...
    <b-row>
      <b-col>
        <server-side-paginated-table
                ...
                ref="displayTable"
                top_right_btn="Add New Exclusion"
        />
      </b-col>
    </b-row>
    <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/exclusions/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/exclusions/get_all',
                    delete_url:'maintenance/exclusions/delete',
                    fields:[
