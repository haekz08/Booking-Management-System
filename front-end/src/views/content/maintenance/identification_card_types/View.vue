...
<script>
    ...
    import FormModal from '@/views/content/maintenance/identification_card_types/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/identification_card_types/get_all',
                    delete_url:'maintenance/identification_card_types/delete',
                    fields:[
                        {key: 'name', label:'Name'},
