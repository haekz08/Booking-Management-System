<template>
    <div>
            ...
            <div class="custom-modal-body">
                <b-card class="mb-0">
                    ...
                    <b-row>
                        <b-col sm="3">
                            <img
                                v-if="form_data.ambassador_media.length==0"
                                class="img-fluid"
                                :src="assets_path.MEDSAILING_ASSETS + 'image-not-found.jpg'"
                                @click="upload_modal=!upload_modal"
                            >
                            <img
                                v-else
                                class="img-fluid"
                                :src="assets_path.MEDIA_UPLOADS + form_data.ambassador_media[0].new_file_name"
                                @click="upload_modal=!upload_modal"
                            >
                        </b-col>
                        <b-col>
                            <b-row class="m-0">
                                <b-col md="2" class="pl-0 pr-0">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mt-1" v-model="form_data.guest_title_id" name="guest_title">
                            ...
                            <b-row class="m-0">
                                <b-col md="6" class="pl-0 pr-0">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form_data.phone_number" type="text" class="form-control mt-1" name="phone_number">
                                    </div>
                                </b-col>
                                <b-col md="6" class="pl-2 pr-0">
                                    <div class="form-group">
                            ...
                            <b-row class="m-0">
                                <b-col md="6" class="pl-0 pr-0">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form_data.passport_number" type="text" class="form-control mt-1" name="passport_number">
                                    </div>
                                </b-col>
                                <b-col md="6" class="pl-2 pr-0">
                                    <div class="form-group">
                                        <strong class="text-muted">Exiration Date</strong>
                                        <input v-model="form_data.expiration_date" type="text" class="form-control mt-1" name="expiration_date">
                                    </div>
                                </b-col>
                            </b-row>
                            <b-row class="m-0">
                                <b-col md="6" class="pl-0 pr-0">
                                    <div class="form-group">
                                        ...
                                        <select v-model="form_data.nationality_id" class="form-control mt-1" name="nationality">
                                ...
                                <b-col md="4" class="pl-2 pr-0">
                                    <div class="form-group">
                                        ...
                                        <input @change="getAge" v-model="form_data.birth_date.default" type="date" class="form-control mt-1" name="birth_date">
                                    </div>
                                </b-col>
                            ...
                            <b-row class="m-0">
                                <b-col md="6" class="pl-0 pr-0">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form_data.pob_country" placeholder="Country" type="text" class="form-control mt-1" name="pob_country">
                                    </div>
                                </b-col>
                                <b-col md="6" class="pl-2 pr-0">
                                    <div class="form-group">
                                        <strong class="text-muted">&nbsp;</strong>
                                        <input v-model="form_data.pob_city" placeholder="City" type="text" class="form-control mt-1" name="pob_city">
                                    </div>
                                </b-col>
                            </b-row>
                            <b-row class="m-0">
                                <b-col md="12" class="pl-0 pr-0">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form_data.current_residency" type="text" class="form-control mt-1" name="current_residency">
                                    </div>
                                </b-col>
                            </b-row>
                            <b-row class="m-0">
                                <b-col md="12" class="pl-0 pr-0">
                                    <div class="form-group">
                                        <strong class="text-muted">Instructor Profile</strong>
                                        <input v-model="form_data.instructor_profile" type="text" class="form-control mt-1" name="instructor_profile">
                                    </div>
                                </b-col>
                            </b-row>
                        </b-col>
        ...
        <b-modal header-text-variant="light" header-bg-variant="dark" footer-bg-variant="dark" centered
                 v-model="upload_modal" @close="closeModal" size="lg" body-class="p-0"
                 no-close-on-backdrop no-close-on-esc>
            <template slot="modal-title">
                <div>
                    <h5 v-if="form_data.id==-1"><i class='fa fa-plus-circle'></i>&nbsp;&nbsp;Add New Record<span></span></h5>
            ...
            <div class="custom-modal-body">
                <media @mediaComponentUpdateSelectedImages="updateMedia" :current_images="form_data.ambassador_media"/>
            </div>
            <div slot="modal-footer" class="w-100">
                <div class="float-right">
                    <b-row >
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                this.swalConfirmSubmit((data)=>{
                    if (data.value) {
                        this.$validator.validateAll().then(result=>{
                            if(result){
                                this.is_saving=true;
                                this.axios.post('maintenance/ambassadors/save',this.form_data).then(response => {
                                    this.closeModal();
            ...
            updateMedia(data){
                this.form_data.ambassador_media=data;
            },
            saveImage(){
                this.swalConfirmSubmit((data)=>{
                    if (data.value) {
                        this.is_saving=true;
                        this.axios.post('maintenance/ambassadors/save_image',this.form_data).then(response => {
                            this.closeModal();
                            this.transactionCompleted();
                            this.swalTransactionCompleted();
                            this.is_saving=false;
