...
<script>
    ...
    import FormModal from '@/views/content/maintenance/genders/FormModal.vue';
    export default {
        name: "Index",
        components:{
        ...
        data(){
            return{
                ...
                table_settings:{
                    api_url:'maintenance/genders/get_all',
                    delete_url:'maintenance/genders/delete',
                    fields:[
