...
<script>
    ...
    import FormModal from '@/views/content/maintenance/add_ons/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/add_ons/get_all',
                    delete_url:'maintenance/add_ons/delete',
                    fields:[
        ...
        methods:{
            resetFormData(){
                ...
                this.form_data.is_default_offered=true;
            }
        }
    }
</script>
