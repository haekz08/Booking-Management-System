    ...
    <b-row>
      <b-col>
        <server-side-paginated-table
                ...
                ref="displayTable"
                top_right_btn="Add New Boat Brand"
        />
      </b-col>
    </b-row>
    <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/boat_brands/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/boat_brands/get_all',
                    delete_url:'maintenance/boat_brands/delete',
                    fields:[
                        {key: 'name', label:'Name'},
