        ...
        <b-row>
            <b-col>
                <server-side-paginated-table
                        ...
                        ref="displayTable"
                        top_right_btn="Add New Lead Source"
                />
            </b-col>
        </b-row>
        <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/lead_sources/FormModal.vue';
    export default {
        name: "Index",
        components:{
        ...
        data(){
            return{
                ...
                table_settings:{
                    api_url:'maintenance/lead_sources/get_all',
                    delete_url:'maintenance/lead_sources/delete',
                    fields:[
