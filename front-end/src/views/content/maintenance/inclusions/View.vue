    ...
    <b-row>
      <b-col>
        <server-side-paginated-table
                ...
                ref="displayTable"
                top_right_btn="Add New Inclusion"
        />
      </b-col>
    </b-row>
    <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/inclusions/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/inclusions/get_all',
                    delete_url:'maintenance/inclusions/delete',
                    fields:[
        ...
        methods:{
            resetFormData(){
                ...
                this.form_data.is_default_checked=true;
            }
        }
    }
</script>
