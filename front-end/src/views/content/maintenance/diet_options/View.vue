        ...
        <b-row>
            <b-col>
                <server-side-paginated-table
                        ...
                        ref="displayTable"
                        top_right_btn="Add New Diet Option"
                />
            </b-col>
        </b-row>
        <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/diet_options/FormModal.vue';
    export default {
        name: "Index",
        components:{
        ...
        data(){
            return{
                ...
                table_settings:{
                    api_url:'maintenance/diet_options/get_all',
                    delete_url:'maintenance/diet_options/delete',
                    fields:[
