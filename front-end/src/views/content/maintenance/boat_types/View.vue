    ...
    <b-row>
      <b-col>
        <server-side-paginated-table
                ...
                ref="displayTable"
                top_right_btn="Add New Boat Type"
        />
      </b-col>
    </b-row>
    <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/boat_types/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/boat_types/get_all',
                    delete_url:'maintenance/boat_types/delete',
                    fields:[
                        {key: 'name', label:'Name'},
