    ...
    <b-row>
      <b-col>
        <server-side-paginated-table
                ...
                ref="displayTable"
                top_right_btn="Add New Payment Type"
        />
      </b-col>
    </b-row>
    <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/payment_types/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/payment_types/get_all',
                    delete_url:'maintenance/payment_types/delete',
                    fields:[
