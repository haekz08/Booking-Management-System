    ...
    <b-row>
      <b-col>
        <server-side-paginated-table
                ...
                ref="displayTable"
                top_right_btn="Add New Itinerary Brand"
        />
      </b-col>
    </b-row>
    <form-modal
...
<script>
    ...
    import FormModal from '@/views/content/maintenance/itinerary_brands/FormModal.vue';
    export default {
        ...
        data: () => {
            return {
                ...
                table_settings:{
                    api_url:'maintenance/itinerary_brands/get_all',
                    delete_url:'maintenance/itinerary_brands/delete',
                    fields:[
        ...
        methods:{
            resetFormData(){
                ...
                this.form_data.is_ambassador_required=true;
            }
        }
    }
</script>
