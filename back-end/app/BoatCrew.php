...
class BoatCrew extends Model
{
    ...
    protected $appends = [
        'crew_type_description',
        'full_name'
    ];

    public function itineraries()
    {
        return $this->belongsToMany(Itinerary::class, 'itinerary_crews', 'boat_crew_id', 'itinerary_id');
    }

    public function nationality_details(){
        return $this->belongsTo(Nationality::class, 'nationality_id', 'id');
    }
    public function crew_type()
    {
        return $this->belongsTo(CrewType::class, 'crew_type_id', 'id');
    }

    public function getCrewTypeDescriptionAttribute()
    {
        return $this->crew_type->description;
    }
